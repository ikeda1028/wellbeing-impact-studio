...
- 日本語で書く
- 5枚の提案カードにする
- 各カードは title, body, target, list, intelligence, boardAction を持つ
- target には数値目標を必ず含める
- list は3項目
...
- 一般的な研修提案で終わらせず、取締役レベルの経営アジェンダ、資本市場への説明、競争優位、事業リスク、組織能力投資に接続する
  ...
  "cards": [
    {
      ...
      "body": "組織固有の文脈を踏まえた説明",
      "target": "数値目標",
      "intelligence": "取締役向けインテリジェンス",
      "boardAction": "取締役会で強化・承認・監督すべきこと",
